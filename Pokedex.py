...
class Pokedex:
    ...
    def load_pokemon_images(self, pokemon_attributes):
        ...
        frames = []                                                    #BytesIO object allows the bytes to be read as a stream. Once the raw image bytes have been decoded into a gif, it's useable.
        ...
        self.window.after(0,lambda: self.load_animation_frames(frames))

    def load_animation_frames(self, resized_frames):
